...
public class Template {
    ...
    /* SqlSessionFactory는 어플리케이션이 실행하는 동안 존재해야 하며,
    * 여러차례 SqlSessionFactory를 다시 빌드하지 않는 것이 가장 좋은 형태이다.
    ...
    * */
    ...
    public static SqlSession getSqlSession() {
        ...
        * 따라서 메소드 스코프로 만든다.
        * 여러개의 SqlSessionFactory를 빌드하기 위해 재사용할 수도 있지만 유지하지 않는 것이 가장좋다.
        * */
        ...
        if(sqlSessionFactory == null) {
            ...
            /* SqlSession은 Thread에 안전하지 않고, 공유하지 않아야 하므로 요청 시마다 생성해야 한다. */
