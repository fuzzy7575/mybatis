...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("4. choose(when, set) 확인하기");
    ...
    private static void chooseSubMenu() {
        ...
        do {
            ...
            System.out.println("1. 카레고리 상위 분류별 메뉴 보여주기(식사, 음료, 디저트)");
            System.out.println("9. 이전 메뉴로");
            System.out.print("메뉴 번호를 입력하세요. : ");
            int no = sc.nextInt();
    ...
    private static void trimSubMenu() {
        ...
        do{
            ...
            System.out.println("2. 메뉴명 혹은 카테고리코드로 검색, 단 메뉴와 카테고리 둘 다 일치하는 경우도 검색하며, " +
                    "검색조건이 없는 경우 전체검색");
    ...
    private static Map<String, Object> inputSearchCriteriaMap() {
        ...
        if("category".equals(codition)) {
            System.out.print("검색할 키테고리 코드를 입력하세요. : ");
            int categoryValue = sc.nextInt();

            criteria.put("categoryValue", categoryValue);

        } else if("name".equals(codition)) {
            System.out.print("검색할 이름을 입력하세요. : ");
            String nameValue = sc.nextLine();

            criteria.put("nameValue", nameValue);

        } else if("both".equals(codition)) {
            System.out.print("검색할 이름을 입력하세요. : ");
            String nameValue = sc.nextLine();
            System.out.print("검색할 키테고리 코드를 입력하세요. : ");
            int categoryValue = sc.nextInt();
